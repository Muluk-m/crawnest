  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-white rounded-lg border p-8 text-center mb-6">
        ...
        <h2 className="text-lg font-medium text-gray-500 mb-2">Workspace Coming Soon</h2>
        <p className="text-sm text-gray-400">Chat and task interaction will be available in a future update.</p>
      </div>
